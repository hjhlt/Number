...
with open('./model/conv.t.pkl', 'rb') as f:
    conv = pickle.load(f)

with open('./model/pool1.t.pkl', 'rb') as f:
    pool1 = pickle.load(f)

with open('./model/conv2.t.pkl', 'rb') as f:
    conv2 = pickle.load(f)

with open('./model/hidden1.t.pkl', 'rb') as f:
    hidden1 = pickle.load(f)

with open('./model/softmax.t.pkl', 'rb') as f:
    softmax = pickle.load(f)
...
with open('./model/conv.t.pkl', 'wb') as f:
    pickle.dump(conv, f)

# with open('conv1.t.pkl', 'wb') as f:
#     pickle.dump(conv1, f)

with open('./model/pool1.t.pkl', 'wb') as f:
    pickle.dump(pool1, f)

with open('./model/conv2.t.pkl', 'wb') as f:
    pickle.dump(conv2, f)
#
# with open('pool2.t.pkl', 'wb') as f:
#     pickle.dump(pool2, f)
#
with open('./model/hidden1.t.pkl', 'wb') as f:
    pickle.dump(hidden1, f)

# with open('hidden2.t.pkl', 'wb') as f:
#     pickle.dump(hidden2, f)
#
with open('./model/softmax.t.pkl', 'wb') as f:
