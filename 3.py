    ...
    def backprop(self, d_L_d_out, learn_rate):
        ...
        for i in range(d_L_d_out.shape[0]):
            for j in range(d_L_d_out.shape[1]):
                ...
                for f in range(self.num_filters):
                    d_L_d_input_region += filters_transposed[f] * d_L_d_out[i, j, f]

                    # 将卷积结果放到输入梯度图的正确位置
                d_L_d_input[i:i + 3, j:j + 3] += d_L_d_input_region
...
conv = Conv3x3(4)  # 28x28x1 -> 26x26x8
pool = MaxPool2()  # 26x26x8 -> 13x13x8
hidden = Hidden(13 * 13 * 4, 20)  # 13x13x8 -> 20
softmax = Softmax(20, 10)  # 20 -> 10


# with open('conv.test.pkl', 'rb') as f:
#     conv = pickle.load(f)
#
# with open('pool.test.pkl', 'rb') as f:
#     pool = pickle.load(f)
#
# with open('hidden.test.pkl', 'rb') as f:
#     hidden = pickle.load(f)
#
# with open('softmax.test.pkl', 'rb') as f:
...
#     with open('conv.test.pkl', 'wb') as f:
#         pickle.dump(conv, f)
#
#     with open('pool.test.pkl', 'wb') as f:
#         pickle.dump(pool, f)
#
#     with open('hidden.test.pkl', 'wb') as f:
#         pickle.dump(hidden, f)
#
#     with open('softmax.test.pkl', 'wb') as f:
